...
**Scaling.** For higher session throughput, the feature extraction step can be offloaded to a task queue while the API layer remains lightweight and stateless, returning a job ID immediately and delivering results asynchronously.
